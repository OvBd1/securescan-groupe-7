      ...
      <aside className="w-64 bg-[#111623] border-r border-gray-800 flex flex-col justify-between hidden md:flex shrink-0">
        <div>
          ...
          <nav className="mt-2 px-4 space-y-2">
            ...
            <Link to="/dashboard/vulnerabilites" className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition ${isActive('vulnerabilites') ? 'bg-blue-600 text-white shadow-lg' : 'text-gray-400 hover:text-white hover:bg-[#161d2d]'}`}>
              <AlertTriangle size={18} /> <span className="font-medium">Vulnérabilités</span>
            </Link>
